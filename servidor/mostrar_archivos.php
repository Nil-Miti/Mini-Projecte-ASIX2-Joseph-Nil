...
// Crear el directorio del grupo si no existe
if (!is_dir($ruta_grupo)) {
    mkdir($ruta_grupo, 0777, true);
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_file'])) {
    ...
    $ruta_archivo = "$ruta_grupo/$archivo";
...
$archivos_grupo = is_dir($ruta_grupo) ? scandir($ruta_grupo) : [];
?>
<!DOCTYPE html>
<html lang="es">
<head>
